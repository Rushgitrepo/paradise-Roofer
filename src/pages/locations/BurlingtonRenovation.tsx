...
export default function BurlingtonRenovation() {
    return (
        <Layout>
            <PageSEO 
                title="Complete Home Renovation Services in Burlington | Paradise Roofers"
                description="Top-rated interior and exterior renovation contractors in Burlington. Let Paradise Roofers upgrade your kitchen, bathroom, basement, and more."
                canonicalUrl="https://paradiseroofers.com/locations/burlington/renovation/"
            />
