...
export default function RichmondHillRenovation() {
    return (
        <Layout>
            <PageSEO 
                title="Complete Home Renovation Services in RichmondHill | Paradise Roofers"
                description="Top-rated interior and exterior renovation contractors in RichmondHill. Let Paradise Roofers upgrade your kitchen, bathroom, basement, and more."
                canonicalUrl="https://paradiseroofers.com/locations/richmond-hill/renovation/"
            />
